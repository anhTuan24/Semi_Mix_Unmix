...
from mum.data.dataset_mapper import DatasetMapperSupOnly
...
def build_detection_sup_train_loader(cfg, mapper=None):
    ...
    if cfg.SEMISUPNET.Augtype=='weak':
        mapper = DatasetMapper(cfg, True)
    elif cfg.SEMISUPNET.Augtype == 'strong':
        mapper = DatasetMapperSupOnly(cfg, True)
